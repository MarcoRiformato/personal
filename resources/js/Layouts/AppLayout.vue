...
<div class="flex">
    ...
    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
        <NavLink :href="route('dashboard')" :active="route().current('dashboard')" class="text-white hover:text-blue-200">
            Dashboard
        </NavLink>
    </div>
    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex pt-5">
        <Link href="/admindashboard" class="text-white hover:text-blue-200">
            Admin
        </Link>
    </div>
</div>
